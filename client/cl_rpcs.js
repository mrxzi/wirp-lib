...
async function rpcExecute(name, ...params) {
  ...
  TriggerNetEvent("nopixel:rpc:request", Resource, name, callID, params, false)
...
async function rpcRequest(origin, name, callID, params, boolean) {
  ...
  TriggerNetEvent("nopixel:rpc:response", origin, callID, response, boolean)
}
...
onNet("nopixel:rpc:response", rpcResponse)
onNet("nopixel:rpc:request", rpcRequest)
